const STRINGS = {
    ...
    "HillDwarf": { en: "Hill Dwarf", jp: "ヒルドワーフ" },
    "MountainDwarf": { en: "Mountain Dwarf", jp: "マウンテンドワーフ" },
    "HighElf": { en: "High Elf", jp: "ハイエルフ" },
    "WoodElf": { en: "Wood Elf", jp: "ウードエルフ" },
    "DarkElf": { en: "Dark Elf", jp: "ダークエルフ" },
    "ForestGnome": { en: "Forest Gnome", jp: "フォレストノーム" },
    "RockGnome": { en: "Rock Gnome", jp: "ロックノーム" },
    "HalfElf": { en: "Half-Elf", jp: "ハーフエルフ" },
    "LightfootHalfling": { en: "Lightfoot Halfling", jp: "ライトフットハーフリング" },
    "StoutHalfling": { en: "Stout Halfling", jp: "スタウトハーフリング" },
